...
public interface IGraphConverter : IComparable<IGraphConverter>
{
    ...
    IGraphNode ToGraph(object obj, IGraphNode? parent = default);
    ...
    /// <param name="parent">The parent entity in the graph hierarchy, if applicable.</param>
    IGraphNode ToGraph(object sceneMember, object model, IGraphNode? parent = default);
    ...
    object ToModel(IGraphNode node);
}

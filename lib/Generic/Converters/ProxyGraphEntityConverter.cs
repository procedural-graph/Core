...
namespace ProceduralGraph.Generic.Converters
{
    ...
    public abstract class ProxyGraphEntityConverter<TEntity, TSceneMember, TKey, TValue> : GraphConverter, IGraphConverter 
...
#else
        private static readonly ImmutableArray<Type> _supportedTypes = ImmutableArray.Create(typeof(TSceneMember), typeof(TEntity));
#endif
        /// <inheritdoc/>

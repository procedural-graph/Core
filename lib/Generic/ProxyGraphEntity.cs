...
{
    /// <summary>
    /// Represents a graph entity that serves as a proxy for a scene member, allowing it to be integrated into the graph structure.
    /// </summary>
    /// <inheritdoc/>
    public abstract class ProxyGraphEntity<TKey, TValue> : GraphEntity<TKey, TValue>, IProxyGraphNode<TValue>

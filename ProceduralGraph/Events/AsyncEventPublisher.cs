...
public readonly struct AsyncEventPublisher<TArgs> : IDisposable
{
    ...
    {
        foreach (AsyncEventListener<TArgs> listener in _event.listeners)
        {
    ...
    {
        ImmutableArray<AsyncEventListener<TArgs>> listeners = _event.listeners;
